...
const data = pageContent["best-practices"];
...
export const Route = createFileRoute("/best-practices")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/best-practices" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/best-practices" },
    ],
  }),
  component: () => <InfoPage slug="best-practices" />,
});
