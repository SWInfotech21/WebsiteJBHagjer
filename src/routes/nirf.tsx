...
export const Route = createFileRoute("/nirf")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://demo.jbhagjerdegreecollege.in/nirf" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://demo.jbhagjerdegreecollege.in/nirf" },
    ],
  }),
  component: () => <InfoPage slug="nirf" />,
});
