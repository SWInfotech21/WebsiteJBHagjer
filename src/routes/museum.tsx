...
export const Route = createFileRoute("/museum")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/museum" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/museum" },
    ],
  }),
  component: () => <InfoPage slug="museum" />,
});
