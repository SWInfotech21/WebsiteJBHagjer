...
const data = pageContent["prospectus"];
...
export const Route = createFileRoute("/prospectus")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/prospectus" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/prospectus" },
    ],
  }),
  component: () => <InfoPage slug="prospectus" />,
});
