...
export const Route = createFileRoute("/idp")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/idp" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/idp" },
    ],
  }),
  component: () => <InfoPage slug="idp" />,
});
