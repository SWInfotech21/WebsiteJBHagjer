...
const data = pageContent["leaders"];
...
export const Route = createFileRoute("/leaders")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/leaders" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/leaders" },
    ],
  }),
  component: () => <InfoPage slug="leaders" />,
});
