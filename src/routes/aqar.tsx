...
export const Route = createFileRoute("/aqar")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/aqar" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/aqar" },
    ],
  }),
  component: () => <InfoPage slug="aqar" />,
});
