...
const data = pageContent["mentor-mentee"];
...
export const Route = createFileRoute("/mentor-mentee")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/mentor-mentee" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/mentor-mentee" },
    ],
  }),
  component: () => <InfoPage slug="mentor-mentee" />,
});
