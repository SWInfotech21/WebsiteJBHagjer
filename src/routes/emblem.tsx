...
export const Route = createFileRoute("/emblem")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/emblem" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/emblem" },
    ],
  }),
  component: () => <InfoPage slug="emblem" />,
});
