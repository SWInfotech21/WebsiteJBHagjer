...
export const Route = createFileRoute("/anthem")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/anthem" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/anthem" },
    ],
  }),
  component: () => <InfoPage slug="anthem" />,
});
