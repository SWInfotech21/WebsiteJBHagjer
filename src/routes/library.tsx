...
const data = pageContent["library"];
...
export const Route = createFileRoute("/library")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/library" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/library" },
    ],
  }),
  component: () => <InfoPage slug="library" />,
});
