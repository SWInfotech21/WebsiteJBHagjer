...
const data = pageContent["annual-report"];
...
export const Route = createFileRoute("/annual-report")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/annual-report" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/annual-report" },
    ],
  }),
  component: () => <InfoPage slug="annual-report" />,
});
