...
export const Route = createFileRoute("/iqac")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://digital-campus-forge.lovable.app/iqac" },
      { property: "og:type", content: "article" },
    ],
    links: [
      { rel: "canonical", href: "https://digital-campus-forge.lovable.app/iqac" },
    ],
  }),
  component: () => <InfoPage slug="iqac" />,
});
